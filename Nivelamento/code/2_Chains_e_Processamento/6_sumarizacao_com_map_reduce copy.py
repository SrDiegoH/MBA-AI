...
chain_sumarize = load_summarize_chain(model, chain_type="map_reduce", verbose=True) #Cria um chain para resumir dados usando "map_reduce". Obs: Fica travando constantemente
